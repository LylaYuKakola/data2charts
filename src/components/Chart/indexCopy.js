  ...
  render() {
    ...
    return (
      <div styleName="chart-container" id={id}>
        ...
        />
        {
          needSettingPanel && <div styleName="chart-setting-btn" onClick={this.showDrawer}>
            <Icon type="setting" />
          </div>
        }
        {
          needSettingPanel && <div styleName="chart-setting-drawer" ref={settingDrawer => this.settingDrawer = settingDrawer}>
